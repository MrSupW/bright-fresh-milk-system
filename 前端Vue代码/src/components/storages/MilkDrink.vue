<template>
  <div class="main_container">
    <h1><i>This is the storage page of MilkDrink</i></h1>
    <el-card>
      <el-row :gutter="20">
        <el-col :span="16">
  ...
  export default {
    ...
    methods:{
      ...
      async getMilkDrinkList(){
        ...
        console.log(info)
        const res = await this.$http.post("getStorage/milkDrink",info);
        console.log('res',res)
        if(res.data.code === 0){
      ...
      async getMilkDrinkSearchList(){
        ...
        const res = await this.$http.post("searchStorage/milkDrink",info);
      ...
      async confirmDelete(){
        ...
        const res = await this.$http.post("/deleteStorage/milkDrink",info);
        if(res.data.code === 0){
          this.$message.success({message:res.data.msg,duration:1000})
          this.refreshData();
        }
        ...
        this.$refs.editFormRef.validate(async valid => {
          ...
          if(valid){
            if(await this.judgeCodeValidation(this.nowCode, this.editFormData.code)){
              const res = await this.$http.post("/editStorage/milkDrink",this.editFormData);
              if(res.data.code === 0){
                this.$message.success({message:res.data.msg,duration:1000})
                this.refreshData();
              }
        ...
        this.$refs.addNewFormRef.validate(async valid => {
          if(valid){
            if(await this.judgeCodeValidation(null, this.addNewFromData.code)){
              ...
              const res = await this.$http.post("/addNewStorage/milkDrink",this.addNewFromData);
              if(res.data.code === 0){
                this.$message.success({message:res.data.msg,duration:1000})
                this.refreshData();
              }
